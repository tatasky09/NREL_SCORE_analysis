...
| Variable             | Seattle Study Area (n = 33,054) | SCORE Survey Sample (n = 117) |
|----------------------|----------------------------------|--------------------------------|
| **Median Household Income** | $89,130 | $68,334 |
| **Home Ownership** | 64% | 62% |
| **Race and Ethnicity** | 13% Hispanic or Latino | 12% Hispanic or Latino |
| **Disability** | 12% (hearing, visual, cognitive, ambulatory, self-care, or independent living disability) | 25% (condition worsened by a power outage) |
| **Transportation** | 9% do not own a vehicle | 7% do not own or have access to a vehicle |
| **Median Age** | 39 | 42 |
| **Households with Individuals Under 18** | 30% | 58% |
| **Households with Individuals Over 65** | 28% | 23% |
| **Household Size: 1 Person** | 28% | 15% |
| **Household Size: 2 Persons** | 31% | 30% |
| **Household Size: 3 Persons** | 17% | 21% |
| **Household Size: 4+ Persons** | 24% | 35% |
